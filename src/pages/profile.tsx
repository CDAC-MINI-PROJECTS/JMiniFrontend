      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-2">
          ...
          <div className="relative mb-12">
            <PhotoProvider>
              <PhotoView src={ cover || "https://placehold.co/3840x2160/020617/FFFFFF?text=2025+MohiniMahajan"}>
                <img
                  src={cover || "https://placehold.co/3840x2160/020617/FFFFFF?text=Mohini+Mahajan"}
                  className="w-full h-48 object-cover lg:h-96 rounded-lg"
                  alt="Fr"
                  onError={(e) => {
                    e.currentTarget.src = "https://placehold.co/3840x2160/020617/FFFFFF?text=2025+MohiniMahajan";
                  }}
                />
              </PhotoView>
            </PhotoProvider>
              ...
              <Dialog>
                ...
                <DialogContent className="lg:max-w-md">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Button type="submit" size="icon" onClick={() => {navigator.clipboard.writeText(``); toast({title: "Copied to clipboard."});}}>
